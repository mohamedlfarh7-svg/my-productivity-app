...
<template>
  <div class="min-h-screen p-6 md:p-16 flex justify-center">
    <div class="w-full max-w-xl">
      
      <header class="mb-12 border-l-4 border-blue-500 pl-6">
        <h1 class="text-4xl font-black text-white tracking-tight">CORE<span class="text-blue-500">TASK</span></h1>
        <p class="text-slate-500 text-xs font-bold uppercase tracking-[0.3em] mt-1">Efficiency Engine</p>
      </header>
